 ...
 * @author V Hariharan
 */
public class ap1 extends javax.swing.JFrame {
String y="";
String z = "";
    /**
     * Creates new form ap1
     */
    public ap1() {
        initComponents();
    ...
    public ap1(String a,String b,ImageIcon icon) {
        initComponents();
        ...
        jLabel8.setText(y);
        String barcode = Code128.encode(y);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            message.setSubject("Your Smartcard request is approved.");
            
            
            message.setText("Your Smartcard Number is "+y);
            javax.mail.Transport.send(message);
            JOptionPane optionPane = new JOptionPane("Mail Sent successfully to the user",JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ap1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
    //</editor-fold>
