 ...
 * @author V Hariharan
 */
public class apdr extends javax.swing.JFrame {
    String p,x,y,z;
    /**
     * Creates new form apdr
     */
    public apdr() {
        initComponents();
    }
    public apdr(String a) {
        initComponents();
        name.setText(a);
    }
    /**
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Upload PAN Card Here");
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        try
        {
            ...
            PreparedStatement ps = con.prepareStatement("insert into alld( Anum,Pnum,Lnum,Rnum,Aimg,Pimg,Limg,Rimg,username) values(?,?,?,?,?,?,?,?,?)");
            InputStream is = new FileInputStream(new File(p));
            InputStream is1 = new FileInputStream(new File(x));
            InputStream is2 = new FileInputStream(new File(y));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(apdr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
