 ...
 * @author V Hariharan
 */
public class apv extends javax.swing.JFrame {
    String x,y,z;
    /**
     * Creates new form apv
     */
    public apv() {
        initComponents();
    }
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        ...
        try
        {
            ...
            PreparedStatement ps = con.prepareStatement("insert into alld( Anum,Pnum,Vnum,Aimg,Pimg,Vimg,username) values(?,?,?,?,?,?,?)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(apv.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
