 ...
 * @author V Hariharan
 */
public class adr extends javax.swing.JFrame {
    String x,y,z;
    /**
     * Creates new form adr
     */
    public adr() {
        initComponents();
    }
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        ...
        try
        {
            ...
            PreparedStatement ps = con.prepareStatement("insert into alld( Anum,Lnum,Rnum,Aimg,Limg,Rimg,username) values(?,?,?,?,?,?,?)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(adr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
