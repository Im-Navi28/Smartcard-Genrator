 ...
 * @author V Hariharan
 */
public class apr extends javax.swing.JFrame {
    String x,y,z;
    /**
     * Creates new form apr
     */
    public apr() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Upload Ration Card Here");
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        ...
        try
        {
            ...
            PreparedStatement ps = con.prepareStatement("insert into alld( Anum,Pnum,Rnum,Aimg,Pimg,Rimg,username) values(?,?,?,?,?,?,?)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(apr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
