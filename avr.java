...
public class avr extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Upload Voter ID Here");
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        ...
        try
        {
            ...
            PreparedStatement ps = con.prepareStatement("insert into alld( Anum,Vnum,Rnum,Aimg,Vimg,Rimg,username) values(?,?,?,?,?,?,?)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(avr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
