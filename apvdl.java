 ...
 * @author V Hariharan
 */
public class apvdl extends javax.swing.JFrame {
    String p,x,y,z;
    /**
     * Creates new form apvdl
     */
    public apvdl() {
        initComponents();
    }
    public apvdl(String a) {
        initComponents();
        name.setText(a);
    }
    /**
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        try
        {
            ...
            PreparedStatement ps = con.prepareStatement("insert into alld( Anum,Pnum,Vnum,Lnum,Aimg,Pimg,Vimg,Limg,username) values(?,?,?,?,?,?,?,?,?)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(apvdl.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
