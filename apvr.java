 ...
 * @author V Hariharan
 */
public class apvr extends javax.swing.JFrame {
    String p,x,y,z;
    /**
     * Creates new form apvr
     */
    public apvr() {
        initComponents();
    }
    public apvr(String a) {
        initComponents();
        name.setText(a);
    }
    /**
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        try
        {
            ...
            PreparedStatement ps = con.prepareStatement("insert into alld( Anum,Pnum,Vnum,Rnum,Aimg,Pimg,Vimg,Rimg,username) values(?,?,?,?,?,?,?,?,?)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(apvr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
